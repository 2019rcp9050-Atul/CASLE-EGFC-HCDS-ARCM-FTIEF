# CASLE-EGFC-HCDS-ARCM-FTIEF

Reproducibility repository for the research manuscript:

**"Causality-Driven Hybrid Intrusion Detection with Entropy-Aware Feature Learning and Federated Intelligence"**
...
The benchmark datasets used in this study are publicly available from their respective original data providers. The original datasets are not redistributed in this repository.
...
Stratosphere Laboratory / Zenodo:
...
- Feature-selection and feature-learning procedures
- Causal signature analysis
- Entropy-guided feature learning
- Hybrid cognitive detection
